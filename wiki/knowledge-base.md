...
- choose hosting posture without forcing a provider;
- write the bootstrap plan into the generated project `README.md`;
- remove the upstream template remote by default.

## Main Files

- `README.md` - user-facing quick start, examples, hosting modes, smoke verification.
...
- `-Hosting` - one of `custom`, `none`, `digitalocean`, `yandex`; default is `custom`.
